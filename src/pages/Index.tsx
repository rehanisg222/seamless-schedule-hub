          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="mt-2 text-primary-foreground/80">
                Book an appointment now and take the first step towards success.
              </p>
            </div>
            <button
        ...
        <Container>
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Hear from businesses that have experienced significant growth with our services.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map((index) => (
              <div key={index} className="bg-white p-6 rounded-xl border border-border shadow-sm fade-in-section">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-medium">Client Name {index}</h3>
                    <p className="text-sm text-muted-foreground">Company {index}</p>
                  </div>
                </div>
                <p className="text-muted-foreground">
                  "The services provided exceeded our expectations. Our business has seen remarkable growth since implementing their solutions. Highly recommended!"
                </p>
              </div>
            ))}
          </div>
