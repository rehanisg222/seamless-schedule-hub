import { Instagram, Facebook, Linkedin, BarChart, Megaphone, Camera } from "lucide-react";
...
const ServiceCard = ({
  ...
  return <div className={cn("relative rounded-xl p-6 border border-border bg-card transition-all duration-300 hover:shadow-md group", className)}>
